...
namespace WxMpSdk
{
    ...
    public static class RequestUtility
    {
        ...
        public static void DownloadGet(string url, Stream stream)
        {
            WebClient wc = new WebClient();
        ...
        public static Stream DownLoadPost(string url, Stream postStream)
        {
            //创建HTTP请求
                ...
                foreach (var file in fileDictionary)
                {
                    try
                    {
                        ...
                        using (var fileStream = FileHelper.GetFileStream(fileName))
                        {
                            ...
                            {
                                var t = string.Format(textTemplate, file.Key) + fileName;
